...
public class Block223Application {
	...
	private static ChooseGameWindow chooseGame;
	private static Block223PlayModeView playGameWindow;
	private static HallOfFamePage hallOfFamePage;
	...
	private static JButton adminHomeBtn, loginBtn, blocksSetBtn, gameSetBtn, generalSetBtn, levelSetBtn, chooseGameBtn, playGameBtn, hallOfFameBtn;
	...
	public static void main(String[] args) {
		...
		chooseGame = new ChooseGameWindow();
		playGameWindow = new Block223PlayModeView();
//		try {
//			hallOfFamePage = new HallOfFamePage();
...
//		}
		...
		frames.add(chooseGame);
		frames.add(playGameWindow);
//		frames.add(hallOfFamePage);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				playGameBtn.addActionListener(new ActionListener(){
					@Override
					public void actionPerformed(ActionEvent e) {
						playGameWindow.refresh();
						playGameWindow.setVisible(true);
					}
				});
				
				chooseGameBtn = new JButton();
...
//				
//				hallOfFameBtn = new JButton();
//				hallOfFameBtn.addActionListener(new ActionListener(){
//					@Override
//					public void actionPerformed(ActionEvent e) {
//						hallOfFamePage.refresh();
//						hallOfFamePage.setVisible(true);
//					}
//				});
	...
	public static Block223PlayModeView getPlayWindow() {
		return playGameWindow;
	}
	...
	//setter and getter for current PlayedGame
...
//	}
	...
	//TODO setCurrentPlayableGame(PlayedGame  aGame)  method  that  remembers  the  current  playable  game and
	//    a getCurrentPlayableGame() method that returns the current playable game
