...
public class Block223
{
  ...
  public Player addPlayer(String aName, String aPassword)
  {
    return new Player(aName, aPassword, this);
  }
  ...
  /* Code from template association_AddManyToOne */
  public Game addGame(String aName, GameSetting aGameSetting, HallOfFame aHallOfFame, BlockSelection aBlockSelection)
  {
    return new Game(aName, aGameSetting, aHallOfFame, this, aBlockSelection);
  }
